            ...
            {isFree && currentProjectCount >= 2 && (
              <Alert className="bg-amber-500/10 border-amber-500/20">
                ...
                <AlertDescription className="text-amber-300/80">
                  ...
                  {currentProjectCount === 2
                    ? "This will be your last free project. Upgrade to Visionary Studio Pro for unlimited projects."
                    : "Free plan is limited to 3 projects. Upgrade to Visionary Studio Pro to create more projects."}
                </AlertDescription>
              </Alert>
            )}
